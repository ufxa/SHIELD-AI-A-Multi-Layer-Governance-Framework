...
\textcolor{red}{Romualdo~[Sobrenome]},~Marcelo~A.~da~Silva,~and~Allan~D.~B.~Costa%
...
\thanks{\textcolor{red}{[PENDENTE]} R.~[Sobrenome] is with the University of Brasília (UnB),
\textcolor{red}{[Departamento]}, Brasília, DF, Brazil
(e-mail: \textcolor{red}{[email@mail.com]}).}%
...
The authors acknowledge the use of large language model (LLM) assistance for grammar
refinement and bibliography formatting in the preparation of this manuscript, in accordance
with IEEE's Authorship and AI Policy.
All scientific content, experimental design, data analysis, and conclusions are the sole
responsibility of the human authors.
The SHIELD-AI framework design, the six-layer architecture, the formal definitions and
proofs, the PC3 routing algorithm, and all quantitative results are original human
contributions. Benchmark data are derived from the publicly available CICIDS-2017 dataset
and synthetic extensions generated and validated by the authors; no benchmark figures were
produced or altered by the LLM assistant.
